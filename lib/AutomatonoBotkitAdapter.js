...
class AutomatonoBotkitAdapter {
  ...
  processConversation(conversationNode) {
    ...
    bot.hears(conversationNode.listenFor, 'direct_message,direct_mention,mention', function(bot, incomingMessage) { bot.startConversation(incomingMessage, processNode(conversationNode)); }.bind(this));
  }
}
