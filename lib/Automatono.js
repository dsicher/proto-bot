...
class Automatono {
  constructor(automatonoAdapter) {
    this.processConversation = automatonoAdapter.processConversation;
  ...
  logDepth(isIncrement, msg) {
    ...
    console.log(this.currentDepth + ' ' + msg);
    if (!isIncrement) {
  ...
  defaultsTo(respondWith) {
    ...
    if (this.currentNodeStack.length>0) {
      ...
      console.log('Closing and Processing Conversation...');
      console.log('======================================');
    }
